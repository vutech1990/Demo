...
<div class="max-w-4xl mx-auto px-4 md:px-0">
    ...
    <form action="/posts" method="POST" id="post-form" enctype="multipart/form-data" class="space-y-8">
        ...
        <div class="bg-white rounded-2xl shadow-xl shadow-blue-900/[0.03] border border-gray-100 p-6 md:p-10 space-y-8">
            {{-- Tiêu đề --}}
            <div>
                <label for="title"
                ...
                <input type="text" id="title" name="title" value="{{ old('title') }}" required
                    class="w-full px-6 py-4 bg-gray-50 border border-transparent rounded-xl focus:bg-white focus:border-blue-500 focus:ring-4 focus:ring-blue-500/10 focus:outline-none transition-all duration-300 font-extrabold text-gray-900 text-lg md:text-2xl placeholder-gray-300 @error('title') border-red-500 bg-red-50/30 @enderror"
                ...
                <div>
                    ...
                    <div class="relative mb-4">
                        <input type="text" id="tags-input" name="tags" value="{{ old('tags') }}"
                            class="w-full px-5 py-4 bg-gray-50 border border-transparent rounded-xl focus:bg-white focus:border-blue-500 focus:ring-4 focus:ring-blue-500/10 focus:outline-none transition-all duration-300 font-bold text-gray-800 placeholder-gray-300"
        ...
        <div class="flex flex-col md:flex-row items-center justify-between gap-6 pt-4">
            ...
            <button type="submit"
                class="w-full md:w-auto px-12 py-5 bg-blue-600 hover:bg-black text-white font-extrabold rounded-xl shadow-2xl shadow-blue-200 transition-all transform hover:-translate-y-1 active:scale-95 flex items-center justify-center">
